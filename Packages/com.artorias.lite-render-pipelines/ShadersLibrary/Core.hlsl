...
#include "SRPCoreShaderLibrary.hlsl"
#include "GlobalConstantsInput.hlsl"
...
FVertexPositionInputs GetVertexPositionInputs(float3 positionOS)
{
    FVertexPositionInputs input;
...
FVertexNormalInputs GetVertexNormalInputs(float3 normalOS)
{
    FVertexNormalInputs tbn;
...
FVertexNormalInputs GetVertexNormalInputs(float3 normalOS, float4 tangentOS)
{
    FVertexNormalInputs tbn;
