...
namespace LiteRP
{
    ...
    {
        private static readonly ProfilingSampler s_InitRGFramePassSampler = new ProfilingSampler("LiteRP.InitRenderGraphFramePass");
        ...
        {
            using var builder = renderGraph.AddUnsafePass<InitRenderGraphFramePassData>(s_InitRGFramePassSampler.name, out var passData, s_InitRGFramePassSampler);
